...
DOCKER_BUILDKIT=1 docker build --rm --platform linux/amd64 -t shipping-test .
...
DOCKER_BUILDKIT=1 docker run -p 0.0.0.0:3000:3000 --env-file .env.local --rm shipping-test
